...
export function computeWaypoints(layout: Layout): Waypoint[] {
...
export function createLobster(): Lobster {
  return {
    x: 0,
    y: 0,
    phase: 'roaming',
...
export function updateLobster(lobster: Lobster, botState: string, layout: Layout): void {
...
function initLobster(lobster: Lobster, botState: string, layout: Layout, waypoints: Waypoint[]): void {
...
function handleTransitions(lobster: Lobster, botState: string, _layout: Layout, waypoints: Waypoint[]): void {
...
function walkToward(lobster: Lobster, destX: number, destY: number): boolean {
...
function updateRoaming(lobster: Lobster, waypoints: Waypoint[]): void {
  const wp = waypoints[lobster.waypointIndex]
...
function advanceWaypoint(lobster: Lobster, waypoints: Waypoint[]): void {
