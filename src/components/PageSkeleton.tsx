...
type SkeletonVariant = 'kanban' | 'calendar' | 'files' | 'skills' | 'soul' | 'memory' | 'settings' | 'credentials'
...
export default function PageSkeleton({ variant, text = 'Loading\u2026' }: PageSkeletonProps) {
  const VariantComponent = variant ? variants[variant] : undefined
